...
export default function ItemAvalia(props) {
  ...
  return (
    <tr>
      <td>
        <img src={props.avalia.personal.foto} alt={`Foto de ${props.avalia.personal.nome}`} width={60} />        
      </td>
      <td>{props.avalia.personal.nome}</td>
      <td><Estrelas soma={props.avalia.personal.soma} num={props.avalia.personal.num} /></td>
