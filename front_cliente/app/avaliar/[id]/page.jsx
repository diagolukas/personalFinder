...
//    const avaliacao = {...data, cliente_id: clienteId, personal_id: personal.id, data: new Date()}
    ...
    // const altera = {soma: Number(personal.soma) + Number(data.estrelas), num: Number(personal.num) + 1}
    // const atualiza_estrelas = await fetch("http://localhost:3004/personals/"+personal.id,
    //   {
    //     method: "PATCH",
    //     headers: { "Content-type": "application/json" },
          ...
          <div className="card">
            ...
            <div className="card-body">
              ...
              <p className="card-text">
                {personal.genero} - {personal.duracao}
              </p>
              <p className="card-text small">
                Atores Principais: {personal.artista}
              </p>
              <p className="card-text small">
                {personal.sinopse}
              </p>
